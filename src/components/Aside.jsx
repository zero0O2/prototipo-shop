            ...
            <div class="flex flex-col items-baseline  justify-baseline top-0 h-[120px] bg-[var(--quarta)] shadow-sm shadow-[#00000018]">
                ...
                <div class="flex w-[100%] h-[100%] justify-center items-center px-[20px]">
                    <ul class="flex w-[100%] justify-center items-center gap-x-[25px] text-[var(--sexta)]">
                        <Link to={"/"} class={`cursor-pointer ${page == 'home'? 'text-[var(--quinta)]' : 'text-[var(--sexta)]'}`}>
                            <p>Home</p>
                        </Link>
                        <Link to={"/shop"} class={`cursor-pointer ${page == 'shop'? 'text-[var(--quinta)]' : 'text-[var(--sexta)]'}`}>
                            <p>Shop</p>
                        </Link>
                        <Link to={"/produtos"} class={`cursor-pointer ${page == 'produtos'? 'text-[var(--quinta)]' : 'text-[var(--sexta)]'}`}>
                            <p>Produtos</p>
                        </Link>
                    </ul>
                </div>
